LIBS=("qmp" "libxml2" "hdf5" "fftw" "qio" "qdpxx" "qdpxx_single" "quda" "qphix" "chroma" "chroma_single")
...
GET[qio]='${GIT_CLONE} git@github.com:usqcd-software/qio.git ${SOURCE[$LIBRARY]}; pushd ${SOURCE[$LIBRARY]}; git checkout ${GIT_BRANCH[qio]}; ${GIT_UPDATE_SUBMODULES}; popd; '
GET[qdpxx]='${GIT_CLONE} git@github.com:usqcd-software/qdpxx.git ${SOURCE[$LIBRARY]}; pushd ${SOURCE[$LIBRARY]}; git checkout ${GIT_BRANCH[qdpxx]}; ${GIT_UPDATE_SUBMODULES}; popd; '
GET[qdpxx_single]='${GIT_CLONE} git@github.com:usqcd-software/qdpxx.git ${SOURCE[$LIBRARY]}; pushd ${SOURCE[$LIBRARY]}; git checkout ${GIT_BRANCH[qdpxx_single]}; ${GIT_UPDATE_SUBMODULES}; popd; '
GET[quda]='${GIT_CLONE} git@github.com:lattice/quda.git ${SOURCE[$LIBRARY]}; pushd ${SOURCE[$LIBRARY]}; git checkout ${GIT_BRANCH[quda]}; ${GIT_UPDATE_SUBMODULES}; mkdir -p externals/eigen/; curl https://bitbucket.org/eigen/eigen/get/3.3.4.tar.bz2 -o externals/eigen/3.3.4.tar.bz2; popd; '
...
OTHER_LIBS[hdf5]=""
OTHER_LIBS[fftw]=""
OTHER_LIBS[qio]="other_libs/c-lime "
...
CONFIGURE[qio]='${SOURCE[qio]}/configure '
...
CONFIG_FLAGS[qio]='--prefix=${INSTALL[qio]} --with-qmp=${INSTALL[qmp]} --enable-largefile --enable-dml-output-buffering --enable-dml-bufsize=33554432'
...
CXX_FLAGS[qio]='${CXX_FLAGS[DEFAULT]}'
...
CPP_FLAGS[qmp]='${CPP_FLAGS[DEFAULT]}'
CPP_FLAGS[libxml2]='${CPP_FLAGS[DEFAULT]}'
CPP_FLAGS[hdf5]='${CPP_FLAGS[DEFAULT]}'
CPP_FLAGS[fftw]='${CPP_FLAGS[DEFAULT]}'
CPP_FLAGS[qio]='${CPP_FLAGS[DEFAULT]}'
CPP_FLAGS[qdpxx]='${CPP_FLAGS[DEFAULT]}'
CPP_FLAGS[qdpxx_single]='${CPP_FLAGS[DEFAULT]}'
CPP_FLAGS[quda]='${CPP_FLAGS[DEFAULT]}'
CPP_FLAGS[qphix]='${CPP_FLAGS[DEFAULT]}'
CPP_FLAGS[chroma]='${CPP_FLAGS[DEFAULT]}'
CPP_FLAGS[chroma_single]='${CPP_FLAGS[DEFAULT]}'
...
QUDA_LIBS[qio]='${QUDA_LIBS[DEFAULT]}'
...
MESSAGE[qio,DEFAULT]='${MESSAGE[DEFAULT]}'
...
MESSAGE[qio,report]='${MESSAGE[qio,DEFAULT]}'
MESSAGE[qio,get]='${MESSAGE[qio,DEFAULT]}'
MESSAGE[qio,configure]='${MESSAGE[qio,DEFAULT]}'
MESSAGE[qio,make]='${MESSAGE[qio,DEFAULT]}'
MESSAGE[qio,install]='${MESSAGE[qio,DEFAULT]}'
MESSAGE[qio,complete]='${MESSAGE[qio,DEFAULT]}'
MESSAGE[qio,clean]='${MESSAGE[qio,DEFAULT]}'
